...
?>
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <!-- <img src="<?php the_field('about_img'); ?>" alt="изображение с ссылкой"> -->
                           <!-- либо вариант с массивом изображения -->
                            <?php
        ...
        <div class="toys" id="toys">
            <div class="container">
                ...
                <h2 class="subtitle"><?php the_field('edu_title');?></h2>
                <div class="toys__wrapper">
                <?php
                    $posts = get_posts( array(
                        'numberposts' => -1,
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('edu_bold');?></span> <?php the_field('edu_descr');?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('story_subtitle_block1');?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('story_descr_block1');?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php
                                $image = get_field('story_img_block1');
                                if(!empty($image)): ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                    <?php
                                $image = get_field('story_img_block2');
                                if(!empty($image)): ?>
                            <img class="aboutus__img"
                             src="<?php echo $image['url']; ?>"
                              alt="<?php echo $image['alt']; ?>"
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('story_subtitle_block2');?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('story_descr_block2');?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                        <?php the_field('story_subtitle_block3');?>
                        </div>
                        <div class="aboutus__text">
                        <?php the_field('story_descr_block3');?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    <?php
                                $image = get_field('story_img_block3');
                                if(!empty($image)): ?>
                            <img class="aboutus__img"
                             src="<?php echo $image['url']; ?>"
                              alt="<?php echo $image['alt']; ?>"
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                       ...
                       <?php echo do_shortcode('[contact-form-7 id="180" title="Форма отзывов"]');?>
                       </div>
                    </div>
                </div>
                <div class="row mt70">
