<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                  <?php echo do_shortcode('[contact-form-7 id="181" title="Оставьте ваш вопрос здесь"]');?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('ytb', 2);?>" class="footer__social-item">
        ...
        <?php
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA4euNhLS1SLF7xtFfuk2KQkSVmbVlIa5I"></script> 
        <script>
        (function($) {
        function new_map( $el ) {
